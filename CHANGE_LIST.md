Список изменений 0.6.6 alpha(в разработке):
- Обновлены зависимости;
- Добавлен django-axes;
- Добавлен 5socks для проксирования telegram бота;

Список изменений 0.6.5 alpha(текущая версия):
...
- Добавлен новый инструмент "Whois / Проверка IP и домена" с адаптивным дизайном;
- Улучшен UI поиска: фиксированные кнопки, иконки и адаптация под мобильные устройства;
- Добавлена поддержка стандарта RFC 9116 (файл security.txt) для описания политик безопасности;

Список изменений 0.6.4 alpha:
- Исправлены ошибки;
